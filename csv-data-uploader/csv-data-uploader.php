...
Description: This Plugin will uploads CSV data to DB Tables
Author: Ashish Rana
Version: 1.0.0
...
add_shortcode("csv-data-uploader", "cd_display_uploader_form");
function cd_display_uploader_form(){
    ob_start();
...
add_action("wp_ajax_cdu_submit_form_data", "cdu_ajax_handler"); // when user is login
